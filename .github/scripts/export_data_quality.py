...
"""
Export Data Quality table from Airtable to CSV for Tableau.
"""
...
BASE_ID = 'app0Ljjhrp3lTTpTO'     # replace with your Airtable Base ID
MAIN_TABLE = 'Data Quality'       # exact name of your table in Airtable
VIEW_NAME = 'Grid view'           # change if you use a different view
